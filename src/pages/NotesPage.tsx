        ...
        <GlassCard className="p-4 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full glass rounded-lg pl-9 pr-3 py-2 text-xs text-foreground bg-transparent outline-none"
            />
          </div>
          ...
          <motion.button
            whileTap={{ scale: 0.95 }}
            onClick={addNote}
            className="w-full py-2 rounded-xl bg-primary/15 text-primary text-xs font-medium flex items-center justify-center gap-1.5 hover:bg-primary/25 transition-colors"
          >
