        ...
        <motion.div variants={staggerItem} className="lg:col-span-2">
          <GlassCard className="p-8 flex flex-col items-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.button whileTap={{ scale: 0.85 }} onClick={() => add(1)}
                className="w-14 h-14 rounded-full bg-primary text-primary-foreground flex items-center justify-center glow-primary">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <input
                ...
                className="w-16 glass rounded-xl px-2 py-1 text-sm text-foreground bg-transparent outline-none text-center tabular-nums"
              />
            </div>
          </GlassCard>
        </motion.div>
