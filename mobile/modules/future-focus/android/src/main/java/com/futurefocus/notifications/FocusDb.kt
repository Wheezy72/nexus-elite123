...
import com.futurefocus.notifications.models.AnalyticsSummary
import com.futurefocus.notifications.models.DistractionItem
import com.futurefocus.notifications.models.SessionSummary
...
class FocusDb(context: Context) {
  ...
  private class DbHelper(context: Context) : SQLiteOpenHelper(context, "future_focus.db", null, 2) {
