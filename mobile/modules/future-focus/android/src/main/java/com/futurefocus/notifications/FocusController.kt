...
import com.futurefocus.notifications.models.FocusStatus

object FocusController {
  private const val PREFS = "future_focus_state"

  fun hasNotificationAccess(context: Context): Boolean {
    val cn = ComponentName(context, FutureNotificationListenerService::class.java)
