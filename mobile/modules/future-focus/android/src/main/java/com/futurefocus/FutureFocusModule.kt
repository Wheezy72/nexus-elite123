...
import com.futurefocus.notifications.FocusController
import com.futurefocus.notifications.FocusDb
import com.futurefocus.notifications.FocusSettingsStore
import com.futurefocus.notifications.FocusScheduleManager
import com.futurefocus.notifications.GamificationStore
import com.futurefocus.notifications.models.BlockLevel

class FutureFocusModule(private val reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
  private val db = FocusDb(reactContext)
  private val settings = FocusSettingsStore(reactContext)

  override fun getName(): String = "FutureFocus"
